...
CREATE TABLE IF NOT EXISTS users (
  ...
  UNIQUE KEY uq_users_landing_slug (landing_slug),
...
CREATE TABLE IF NOT EXISTS affiliate_social_accounts (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY uq_affiliate_social_platform (user_id, platform),
  CONSTRAINT fk_affiliate_social_user
    FOREIGN KEY (user_id) REFERENCES users(id)
...
CREATE TABLE IF NOT EXISTS demo_requests (
  ...
  KEY idx_demo_requests_affiliate (affiliate_user_id),
  CONSTRAINT fk_demo_requests_lead
    FOREIGN KEY (lead_id) REFERENCES leads(id)
    ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT fk_demo_requests_affiliate_user
    FOREIGN KEY (affiliate_user_id) REFERENCES users(id)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  UNIQUE KEY uq_quotes_affiliate_customer (affiliate_user_id, lead_id),
  KEY idx_quotes_status (status),
  KEY idx_quotes_lead (lead_id),
  KEY idx_quotes_affiliate (affiliate_user_id),
  ...
  KEY idx_sales_affiliate (affiliate_user_id),
  ...
  CONSTRAINT fk_sales_lead
    FOREIGN KEY (lead_id) REFERENCES leads(id)
    ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT fk_sales_affiliate_user
    FOREIGN KEY (affiliate_user_id) REFERENCES users(id)
    ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS commissions (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_commissions_affiliate_status (affiliate_user_id, status),
  KEY idx_commissions_sale (sale_id),
  CONSTRAINT fk_commissions_sale
    FOREIGN KEY (sale_id) REFERENCES sales(id)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_commissions_affiliate_user
    FOREIGN KEY (affiliate_user_id) REFERENCES users(id)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
