...
function printAreaSevenRentalContractSixPage(contract: BackendRow) {
  ...
  const header = (pageNumber: number) => pageNumber === 1 ? `<div class="cover-title" style="text-align:center;margin:5mm 0 6mm"><h1 style="font-size:20pt;font-weight:800;line-height:1.25">اتفاقية تأجير مساحة</h1><h2 style="font-size:11pt;font-weight:700;margin-top:2mm">بمعرض ملتقى أمن وسلامة الفعاليات بجدة</h2></div>` : "";
  ...
  *{box-sizing:border-box;margin:0;padding:0}body{font-family:Arial,Tahoma,sans-serif;background:#323639;color:#000;line-height:1.55;-webkit-print-color-adjust:exact}.page{width:210mm;height:297mm;padding:12mm 18mm;margin:12px auto;background:#fff;position:relative;box-shadow:0 0 12px rgba(0,0,0,.4);display:flex;flex-direction:column;justify-content:space-between;overflow:hidden}.page-content{flex-grow:1}.header-table{width:100%;border-collapse:collapse;margin-bottom:5px}.header-table td{vertical-align:top;border:none!important;padding:0}.header-right{text-align:right;width:32%}.title-ar{font-size:14pt;font-weight:800;line-height:1.2}.sub-ar{font-size:9pt;color:#333;font-weight:600}.header-center{text-align:center;width:36%}.header-center h1{font-size:15pt;font-weight:800;margin-bottom:2px}.header-center h2{font-size:10pt;font-weight:700;color:#222}.header-left{text-align:left;width:32%}.logo-en{font-size:16pt;font-weight:900;letter-spacing:.5px;font-family:Arial,sans-serif;line-height:1}.sub-en{font-size:8pt;color:#333;line-height:1.2;margin-top:2px;font-weight:600}.header-line{border-bottom:2px solid #000;margin:5px 0 7px}.meta-bar{text-align:center;font-size:10pt;font-weight:700;margin-bottom:10px;word-spacing:2px}.section-title{font-size:12pt;font-weight:800;margin:10px 0 6px;border-right:4px solid #000;padding-right:8px;line-height:1.2}p{font-size:11pt;text-align:justify;margin-bottom:7px;line-height:1.55;color:#111}.dotted-input{border-bottom:1px dotted #000;display:inline-block;min-width:120px;padding:0 5px;text-align:center;font-weight:700}.custom-table{width:100%;border-collapse:collapse;margin:8px 0;font-size:10pt}.custom-table th,.custom-table td{border:1px solid #000;padding:6px 8px;text-align:center}.custom-table th{background:#f4f4f4}.footer-table{width:100%;border-collapse:collapse;border-top:1px solid #aaa;padding-top:4px;margin-top:6px;font-size:8.5pt;color:#444}.footer-table td{border:none!important;padding:0}.signatures-area{margin-top:15px;width:100%}.sig-table{width:100%;border-collapse:collapse}.sig-table td{border:none!important;vertical-align:top;width:50%;font-size:10pt;line-height:1.65}.sig-line{margin-top:15px;border-bottom:1px dotted #000;width:80%}.controls{text-align:center;padding:14px 0}.btn-print{padding:12px 30px;background:#000;color:#fff;border:0;border-radius:5px;font-size:11pt;font-weight:700;cursor:pointer}@media print{body{background:none}.controls{display:none!important}.page{box-shadow:none;margin:0;width:210mm;height:297mm;padding:10mm 15mm;page-break-after:always;page-break-inside:avoid}.page:last-child{page-break-after:avoid}@page{size:A4 portrait;margin:0}}@media screen and (max-width:800px){.page{width:100%;height:auto;margin:0 0 12px;padding:20px}.header-table,.header-table tbody,.header-table tr,.header-table td{display:block;width:100%;text-align:center}.header-left{margin-top:8px}}
