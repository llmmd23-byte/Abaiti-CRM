...
function printAreaSevenRentalContract(contract: BackendRow) {
  ...
  const pdfSizing = `<style>body{font-size:8.5pt;line-height:1.4}.page{padding:12mm 15mm 15mm;margin:15px auto}.header{margin-bottom:5px}.title{font-size:13pt}.title small{font-size:8.5pt}.area-logo{font-size:13pt}.event-logo{font-size:11pt}.area-logo small,.event-logo small{font-size:7.5pt}.page-meta{font-size:8.5pt;margin-bottom:12px}.section{font-size:10pt;margin:10px 0 6px;background:#f2f2f2;padding:3px 8px}.text,.party{font-size:8.5pt;line-height:1.45;margin-bottom:6px}.full-clause p{font-size:8.5pt;line-height:1.45;margin-bottom:6px}.full-clause b{font-size:10pt}.data-table{font-size:8pt;margin:8px 0}.data-table th,.data-table td{padding:4px 6px}.footer{font-size:7pt}@media print{.page{height:297mm;padding:10mm 12mm}.page:last-of-type{page-break-after:avoid}}</style>`;
  const section = (title: string) => `${pdfSizing}<h2 class="section">${title}</h2>${title === "البنود التفصيلية" ? clausesFirst : title === "البنود من الثامن إلى الخامس عشر" ? clausesSecond : ""}`;
...
function printAreaSevenRentalContractSixPage(contract: BackendRow) {
  ...
  const header = () => `<table class="header-table"><tr><td class="header-right"><div class="title-ar">ملتقى أمن وسلامة</div><div class="sub-ar">الفعاليات الثقافية والفنية</div></td><td class="header-center"><h1>عقد تأجير مساحة جناح (بوث)</h1><h2>في معرض ملتقى أمن وسلامة الفعاليات الثقافية والفنية بجدة</h2></td><td class="header-left"><div class="logo-en">AREA SEVEN</div><div class="sub-en">مؤسسة منطقة سبعة للإنتاج الإعلامي والمرئي والمسموع<br>وتنظيم المعارض والمؤتمرات</div></td></tr></table><div class="header-line"></div><div class="meta-bar">رقم العقد: ${contractNumber} &nbsp;|&nbsp; تاريخ العقد: ${contractDate} &nbsp;|&nbsp; مدينة جدة</div>`;
  const section = (title: string) => `<div class="section-title">${title}</div>`;
  const footer = (page: number) => `<table class="footer-table"><tr><td>عقد تأجير مساحة - Area Seven</td><td style="text-align:left">الصفحة ${page} من 6</td></tr></table>`;
  const page = (pageNumber: number, body: string) => `<div class="page" style="page-break-after:${pageNumber === 6 ? "avoid" : "always"}"><div class="page-content">${header()}${body}</div>${footer(pageNumber)}</div>`;
  ...
  *{box-sizing:border-box;margin:0;padding:0}body{font-family:Arial,Tahoma,sans-serif;background:#323639;color:#000;line-height:1.6;-webkit-print-color-adjust:exact}.page{width:210mm;height:297mm;padding:15mm 20mm;margin:20px auto;background:#fff;position:relative;box-shadow:0 0 12px rgba(0,0,0,.4);display:flex;flex-direction:column;justify-content:space-between;overflow:hidden}.page-content{flex-grow:1}.header-table{width:100%;border-collapse:collapse;margin-bottom:8px}.header-table td{vertical-align:top;border:none!important;padding:0}.header-right{text-align:right;width:32%}.title-ar{font-size:13pt;font-weight:800;line-height:1.2}.sub-ar{font-size:8.5pt;color:#333;font-weight:600}.header-center{text-align:center;width:36%}.header-center h1{font-size:14pt;font-weight:800;margin-bottom:2px}.header-center h2{font-size:9.5pt;font-weight:700;color:#222}.header-left{text-align:left;width:32%}.logo-en{font-size:15pt;font-weight:900;letter-spacing:.5px;font-family:Arial,sans-serif;line-height:1}.sub-en{font-size:7pt;color:#333;line-height:1.2;margin-top:3px;font-weight:600}.header-line{border-bottom:2px solid #000;margin:8px 0 12px}.meta-bar{text-align:center;font-size:9.5pt;font-weight:700;margin-bottom:18px;word-spacing:2px}.section-title{font-size:11pt;font-weight:800;margin:16px 0 10px;border-right:4px solid #000;padding-right:8px;line-height:1.2}p{font-size:10pt;text-align:justify;margin-bottom:12px;line-height:1.65;color:#111}.dotted-input{border-bottom:1px dotted #000;display:inline-block;min-width:120px;padding:0 5px;text-align:center;font-weight:700}.custom-table{width:100%;border-collapse:collapse;margin:15px 0;font-size:9.5pt}.custom-table th,.custom-table td{border:1px solid #000;padding:8px 10px;text-align:center}.custom-table th{background:#f4f4f4}.footer-table{width:100%;border-collapse:collapse;border-top:1px solid #aaa;padding-top:6px;margin-top:10px;font-size:8pt;color:#444}.footer-table td{border:none!important;padding:0}.signatures-area{margin-top:25px;width:100%}.sig-table{width:100%;border-collapse:collapse}.sig-table td{border:none!important;vertical-align:top;width:50%;font-size:9.5pt;line-height:1.8}.sig-line{margin-top:20px;border-bottom:1px dotted #000;width:80%}.controls{text-align:center;padding:20px 0}.btn-print{padding:12px 30px;background:#000;color:#fff;border:0;border-radius:5px;font-size:11pt;font-weight:700;cursor:pointer}@media print{body{background:none}.controls{display:none!important}.page{box-shadow:none;margin:0;width:210mm;height:297mm;padding:12mm 15mm;page-break-after:always;page-break-inside:avoid}.page:last-child{page-break-after:avoid}@page{size:A4 portrait;margin:0}}@media screen and (max-width:800px){.page{width:100%;height:auto;margin:0 0 12px;padding:20px}.header-table,.header-table tbody,.header-table tr,.header-table td{display:block;width:100%;text-align:center}.header-left{margin-top:8px}}
  </style></head><body><div class="controls"><button class="btn-print" onclick="window.print()">طباعة العقد كامل (PDF)</button></div>
