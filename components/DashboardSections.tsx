...
function printAreaSevenRentalContractSixPage(contract: BackendRow) {
  ...
  const header = (pageNumber: number) => pageNumber === 1 ? `<div class="cover-title" style="text-align:center;margin:8mm 0 18mm"><h1 style="font-size:22pt;font-weight:800;line-height:1.4">اتفاقية تأجير مساحة</h1><h2 style="font-size:14pt;font-weight:700;margin-top:4mm">بمعرض ملتقى أمن وسلامة الفعاليات بجدة</h2></div>` : "";
  ...
  const page = (pageNumber: number, body: string) => `<div class="page" style="page-break-after:${pageNumber === 6 ? "avoid" : "always"}"><div class="page-content">${header(pageNumber)}${body}</div>${footer(pageNumber)}</div>`;
