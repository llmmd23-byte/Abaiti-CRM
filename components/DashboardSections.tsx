...
function printAreaSevenRentalContractSixPage(contract: BackendRow) {
  ...
  const header = (pageNumber: number) => pageNumber === 1 ? `<div class="cover-title" style="text-align:center;margin:10mm 0 12mm"><h1 style="font-size:18pt;font-weight:800;line-height:1.4">اتفاقية تأجير مساحة</h1><h2 style="font-size:11pt;font-weight:700;margin-top:4mm">بمعرض ملتقى أمن وسلامة الفعاليات بجدة</h2></div>` : "";
