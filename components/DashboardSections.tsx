...
function printAreaSevenRentalContractSixPage(contract: BackendRow) {
  ...
  const header = (pageNumber: number) => pageNumber === 1
    ...
    : `<table class="header-table"><tr><td class="header-right"><div class="title-ar">ملتقى أمن وسلامة</div><div class="sub-ar">الفعاليات الثقافية والفنية</div></td><td class="header-center"><h1>عقد تأجير مساحة جناح (بوث)</h1><h2>في معرض ملتقى أمن وسلامة الفعاليات الثقافية والفنية بجدة</h2></td><td class="header-left"><div class="logo-en">AREA SEVEN</div><div class="sub-en">مؤسسة منطقة سبعة للإنتاج الإعلامي وتنظيم المعارض</div></td></tr></table><div class="header-line"></div><div class="meta-bar">رقم العقد: ${contractNumber} &nbsp;|&nbsp; التاريخ: ${contractDate} &nbsp;|&nbsp; مدينة جدة</div>`;
