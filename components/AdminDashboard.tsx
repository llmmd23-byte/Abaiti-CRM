...
const newDGroups = [
  ...
  {ids: [38, 39, 40], left: 18.5, top: 14},
  {ids: [41, 42, 43], left: 36.5, top: 14},
  {ids: [44, 45, 46], left: 54.5, top: 14},
  {ids: [47, 48, 49], left: 72.5, top: 14},
  {ids: [50, 51], left: 90.5, top: 14},
  {ids: [18, 19, 20, 1, 2, 3], left: 0.5, top: 27},
  {ids: [21, 22, 23, 4, 5, 6], left: 18.5, top: 27},
  {ids: [24, 25, 26, 7, 8, 9], left: 36.5, top: 27},
  {ids: [27, 28, 29, 10, 11, 12], left: 54.5, top: 27},
  {ids: [30, 31, 32, 13, 14, 15], left: 72.5, top: 27},
  {ids: [33, 34, 16, 17], left: 90.5, top: 27},
] as const;
...
export const NEW_BOOTH_GROUPS = [
  ...[
    ...
    {left: 18.1, top: 13.6, width: 13.4, height: 6.6, kind: "d-top"},
    {left: 36.1, top: 13.6, width: 13.4, height: 6.6, kind: "d-top"},
    {left: 54.1, top: 13.6, width: 13.4, height: 6.6, kind: "d-top"},
    {left: 72.1, top: 13.6, width: 13.4, height: 6.6, kind: "d-top"},
    {left: 90.1, top: 13.6, width: 9.2, height: 6.6, kind: "d-top"},
    {left: 0.1, top: 26.6, width: 13.4, height: 12.4, kind: "d-middle"},
    {left: 18.1, top: 26.6, width: 13.4, height: 12.4, kind: "d-middle"},
    {left: 36.1, top: 26.6, width: 13.4, height: 12.4, kind: "d-middle"},
    {left: 54.1, top: 26.6, width: 13.4, height: 12.4, kind: "d-middle"},
    {left: 72.1, top: 26.6, width: 13.4, height: 12.4, kind: "d-middle"},
    {left: 90.1, top: 26.6, width: 9.2, height: 12.4, kind: "d-middle"},
  ] as const,
  ...[
